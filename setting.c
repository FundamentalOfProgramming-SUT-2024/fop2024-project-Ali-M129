...
int setting() 
{
    ...
    const wchar_t *options[] = {L"Game level", L"Player color"};
...
int game_level() 
{
    ...
    const wchar_t *options[] = {L"Give me a GOD of ROUGE" ,L"Hard", L"Medium", L"Easy"};
    int num_options = sizeof(options) / sizeof(options[0]);
    int choice = 0;
    int width = 30, height = num_options * 3; // افزایش فاصله بین گزینه‌ها
    int start_y = (LINES - height) / 2;
...
int color_pick() 
{
    ...
    const wchar_t *options[] = {L"Red" ,L"Blue", L"Green", L"Black"};
    int num_options = sizeof(options) / sizeof(options[0]);
    int choice = 0;
    int width = 30, height = num_options * 3; // افزایش فاصله بین گزینه‌ها
    int start_y = (LINES - height) / 2;
